const defaultBanner = 'Chaos - The Progressive JavaScript Framework';
...
//   { color: '#647eff', pos: 1 }
// ])('Chaos - The Progressive JavaScript Framework'))
//
